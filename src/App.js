  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="user/:userId/onenote/notebooks/notebook/:notebook"
          element={<Notebook />}
        />
        <Route
          path="user/:userId/onenote/notebooks/notebook/:notebook/:section"
          element={<Section />}
        />
        ...
        <Route
          path="admin/onenote/template/add/trainings"
          element={<AddTraining />}
        />
        <Route
          path="admin/onenote/notebook/create"
